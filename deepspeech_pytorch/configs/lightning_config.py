...
class ModelCheckpointConf:
    ...
    filepath: Optional[str] = "/root/autodl-tmp/deepspeech_pytorch/ckpt"
    ...
    mode: str = "min"
    dirpath: Any = "/root/autodl-tmp/deepspeech_pytorch/ckpt"  # Union[str, Path, NoneType]
    filename: Optional[str] = "VCTK_Trained"
    auto_insert_metric_name: bool = True
    every_n_train_steps: Optional[int] = None
    train_time_interval: Optional[str] = None
    every_n_epochs: Optional[int] = 2
    save_on_train_epoch_end: Optional[bool] = True
