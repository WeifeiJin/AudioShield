...
# the supported formats are pcm, speex and speex-wb;
AUDIO_FILE = "output.pcm"
...
def on_open(ws, wsParam):
    ...
    def run(*args):
        ...
        status = STATUS_FIRST_FRAME  # The status information of the audio, identifying whether the audio is the
        # first one, Intermediate one, or last frame
...
def iflytek_ASR(audiofile):

    # Your APPID/APIKey/APISecret
    wsParam = Ws_Param(APPID='your_APPID',
                       APIKey='your_API_key',
